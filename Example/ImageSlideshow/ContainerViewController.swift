...
//
//  Created by Dmitry Kuznetsov on 21/08/2018.
...
class ContainerViewController: ImageSlideshowViewController {
    ...
    @objc func didTap() {
        let fullScreenController = slideshowView.presentFullScreenController(from: self, dismissMode: .onSwipe)
